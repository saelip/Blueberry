...
<head>
    ...
    <script defer src="./assets/js/kph/projectUpdateForm.js"></script>
        ...
        <section class="section dashboard">
			<div class="card">
				...
				<form action="projectUpdate" method="post">
					<input id="project_no" type="hidden" name="project_no" value="${project.project_no }">
					<div>
						<p>프로젝트 제목</p>
						<input name="project_title" type="text" class="form-control" value="${project.project_title } ">
						<p class="project-alert project-title-alert">프로젝트 제목을 입력하세요</p>
					</div>
					<div>
						<p>프로젝트 내용</p>
						<input name="project_content" type="text" class="form-control" value="${project.project_content }">
						<p class="project-alert project-content-alert">프로젝트 내용을 입력하세요</p>
					</div>
					<div>
						<p>시작일</p>
						<input name="project_start" type="date" class="form-control" value="${project.project_start }" />
