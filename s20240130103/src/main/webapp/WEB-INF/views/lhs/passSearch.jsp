            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                <div class="card-body">
                  ...
                  <form class="row g-3 needs-validation" action="userFindPass" method="post" onsubmit="return chk()">
                    <div class="col-12">
                      <label for="yourUsername" class="form-label">가입한 이메일을 입력해주세요</label>
                    ...
                    <div class="col-12">
                      <label for="yourUsername" class="form-label">가입한 아이디를 입력해주세요</label>
                      <div class="input-group has-validation">
