...
<title>비밀번호 변경</title>
<script src="assets/js/lhs/lhsuserLeave.js" defer="defer"></script>
		            ...
		            <div class="row justify-content-center">
		                <div class="col-md-8">
		                    <div class="card midcard">
		                        <div class="card-body">
		                            <form action="userLeave" onsubmit="return chk()" method="post">
		
		                                <div class="row mb-3">
		                                    <label for="newPassword" class="col-md-4 col-lg-3 col-form-label">비밀번호</label>
		                                    <div class="col-md-8 col-lg-9">
		                                        <input name="passwd1" type="password" class="form-control" id="passwd1">
		                                    </div>
		                                </div>
